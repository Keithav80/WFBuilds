...
countdown('2026-02-04, 16:00:00', 'IGE1'); // Annual Events
countdown('2025-12-16, 16:00:00', 'IGE2'); // Event 2 (if multiple)
countdown('2025-10-26, 23:00:00', 'Nightwave'); // Nightwave

countdown('2026-02-03, 19:00:00', 'Devshort'); // Tuesdays
countdown('2026-02-04, 20:00:00', 'WF-int'); // Wednesdays
countdown('2026-02-05, 23:00:00', 'PrimeTime'); // Thursdays
